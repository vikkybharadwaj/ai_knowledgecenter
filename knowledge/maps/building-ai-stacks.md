...
- [ ] **Eval & observability layer** — Langfuse / LangSmith / Braintrust / Arize; why "no eval, no ship" for customer-facing agents. *(Concept groundwork landed: the twelve-lesson [Evals map](evals.md). The vendor-tooling comparison is still open.)*
