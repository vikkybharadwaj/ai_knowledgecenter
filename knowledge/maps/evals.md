...
9. [A safety alarm is only as good as its checks](../notes/safety-alarm-false-alarms.md) — a zero-tolerance gate built on bad checks blocks releases at random.
...
all of this goes wrong is the safety gate (9).

## Next up (the backlog for this section)
- [ ] **Defining "complete" with a failure-mode map**: how to know the suite covers the failures that matter (Tide Stage 4, step 4c).
